...
# Parameters 
    # n_candidates - arbitrary number to densly cover the unit hypercube
    # k_per_edge - arbitrary number to represent the unit hypercube edges. For higher dimensions use less number. For 15 dimensions with 2 per edge itself will be around 4 lakh points.
    # start points could be chosen - default is farthest_pair
    # k_per_edge = 2 for d=15 used for testing
# ------------------------------------------------------------------
# Orthogonal projection to hyperplane sum(x) = t
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Equi-distance (maximin) farthest-point sampling
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Generate interior points along cube edges
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 4) Sobol → projection → equi-distance FPS
# ------------------------------------------------------------------
def phs_sampler(
    d,
    N_target,
    ...
    # Equi-distance FPS reference point selection
